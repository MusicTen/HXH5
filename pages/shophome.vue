<template>
	<view>
		...
		<view class="header" :style="{position:headerPosition}">
			...
			<view class="menu">
				<image mode="widthFix" src="../static/common/face.jpg"></image>
			</view>
		</view>
		<!-- 占位 -->
		...
		<!-- 广告横幅 -->
		<view class="banner">
			<image mode="widthFix" src="../static/shophome/banner.jpg"></image>
		</view>
		<!-- 商品列表 -->
...
export default {
	data() {
		return {
			//轮播
			swiperList:[
				{sid:0,src:'自定义src0',img:'../static/shophome/swiper-img/0.jpg'},
				{sid:1,src:'自定义src1',img:'../static/shophome/swiper-img/1.jpg'},
				{sid:2,src:'自定义src2',img:'../static/shophome/swiper-img/2.jpg'},
				{sid:3,src:'自定义src3',img:'../static/shophome/swiper-img/3.jpg'}
			],
			//分类
			categoryList: [
				[//第一页
					{ cat_id: 0, img: '../static/shophome/category-img/0.png', title: '吹风机' },
					{ cat_id: 1, img: '../static/shophome/category-img/1.png', title: '发箍' },
					{ cat_id: 2, img: '../static/shophome/category-img/2.png', title: '肥皂' },
					{ cat_id: 3, img: '../static/shophome/category-img/3.png', title: '粉饼' },
					{ cat_id: 4, img: '../static/shophome/category-img/4.png', title: '化妆镜' },
					{ cat_id: 5, img: '../static/shophome/category-img/5.png', title: '睫毛膏' },
					{ cat_id: 6, img: '../static/shophome/category-img/6.png', title: '睫毛夹' },
					{ cat_id: 7, img: '../static/shophome/category-img/7.png', title: '精华' },
					{ cat_id: 8, img: '../static/shophome/category-img/8.png', title: '口红' },
					{ cat_id: 9, img: '../static/shophome/category-img/9.png', title: '面膜' }
				],
				[//第二页
					{ cat_id: 10, img: '../static/shophome/category-img/10.png', title: '面霜' },
					{ cat_id: 11, img: '../static/shophome/category-img/11.png', title: '乳液' },
					{ cat_id: 12, img: '../static/shophome/category-img/12.png', title: '梳子' },
					{ cat_id: 13, img: '../static/shophome/category-img/13.png', title: '刷子' },
					{ cat_id: 14, img: '../static/shophome/category-img/14.png', title: '洗脸仪' },
					{ cat_id: 15, img: '../static/shophome/category-img/15.png', title: '洗面奶' },
					{ cat_id: 16, img: '../static/shophome/category-img/16.png', title: '香水' }
				]
			],
			//推荐商品 3个
			pickList:[
				{ goods_id: 0, img: '../static/shophome/pick-img/p1.jpg', price: '￥168', slogan:'限时抢购' },
				{ goods_id: 1, img: '../static/shophome/pick-img/p2.jpg', price: '￥168', slogan:'精选商品' },
				{ goods_id: 2, img: '../static/shophome/pick-img/p3.jpg', price: '￥168', slogan:'今日疯抢' }
			],
			//猜你喜欢列表
			productList:[
				{ goods_id: 0, img: '../static/shophome/img/p1.jpg', name: '商品名称商品名称商品名称商品名称商品名称', price: '￥168', slogan:'1235人付款' },
				{ goods_id: 1, img: '../static/shophome/img/p2.jpg', name: '商品名称商品名称商品名称商品名称商品名称', price: '￥168', slogan:'1235人付款' },
				{ goods_id: 2, img: '../static/shophome/img/p3.jpg', name: '商品名称商品名称商品名称商品名称商品名称', price: '￥168', slogan:'1235人付款' },
				{ goods_id: 3, img: '../static/shophome/img/p4.jpg', name: '商品名称商品名称商品名称商品名称商品名称', price: '￥168', slogan:'1235人付款' },
				{ goods_id: 4, img: '../static/shophome/img/p5.jpg', name: '商品名称商品名称商品名称商品名称商品名称', price: '￥168', slogan:'1235人付款' },
				{ goods_id: 5, img: '../static/shophome/img/p6.jpg', name: '商品名称商品名称商品名称商品名称商品名称', price: '￥168', slogan:'1235人付款' },
				{ goods_id: 6, img: '../static/shophome/img/p7.jpg', name: '商品名称商品名称商品名称商品名称商品名称', price: '￥168', slogan:'1235人付款' },
				{ goods_id: 7, img: '../static/shophome/img/p8.jpg', name: '商品名称商品名称商品名称商品名称商品名称', price: '￥168', slogan:'1235人付款' },
				{ goods_id: 8, img: '../static/shophome/img/p9.jpg', name: '商品名称商品名称商品名称商品名称商品名称', price: '￥168', slogan:'1235人付款' },
				{ goods_id: 9, img: '../static/shophome/img/p10.jpg', name: '商品名称商品名称商品名称商品名称商品名称', price: '￥168', slogan:'1235人付款' }
			],
	...
	onReachBottom(){
		...
		for(let i=1;i<=10;i++){
			...
			let p = { goods_id: goods_id, img: '../static/shophome/img/p'+(goods_id%10==0?10:goods_id%10)+'.jpg', name: '商品名称商品名称商品名称商品名称商品名称', price: '￥168', slogan:'1235人付款' };
